...
INSERT INTO `brands` (`id`, `category_id`, `title`, `slug`) VALUES
(5, 8, 'Iphone', 'iphone'),
(6, 8, 'Samsung', 'samsung'),
(8, 6, 'Asus', 'asus'),
(9, 6, 'Acer', 'acer'),
...
CREATE TABLE `products` (
  ...
  `slug` varchar(150) NOT NULL,
  `is_rgb` tinyint(1) NOT NULL DEFAULT 0,
...
INSERT INTO `products` (`id`, `category_id`, `brand_id`, `title`, `slug`, `is_rgb`, `background`) VALUES
(7, 8, 6, 'Samsung galaxy A21S', 'samsung-galaxy-a21s', 1, '0,15,250'),
...
(1, 'Umid Kurbanov', 'admin', NULL, '$2y$10$X.uS4q7OpNzAGhh/TW/xE.YBgYC80hgcZhP0c26viHXXFImyxAua6', 1, NULL, '2021-11-20 00:27:04', '2021-11-20 00:27:04');
